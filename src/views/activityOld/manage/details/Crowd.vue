    ...
    <div class="advertise-touch mt20">
        <Row type="flex" justify="space-between">
            ...
            <Card dis-hover>
                ...
                <div>
                    <TraitInput placeholder="请选择人群" class="touch-trait" v-bind="crowdData" :value="crowdValue" @on-change="updateCrowd">
                    </TraitInput>
                </div>
            </Card>
    ...
    export default {
        ...
        methods: {
            ...
            setObject(obj) {
                ...
                this.removeList.exportConfig = obj.names.map((item, index) => ({
                    trait_name: item,
